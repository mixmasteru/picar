"""
based on SunFounder (service@sunfounder.com) back_wheels.py
"""
...
class BackWheels(object):
    ...
    def __init__(self, debug=True, bus_number=1, db="config"):
        ...
        self.left_wheel = TB6612.Motor(self.Motor_A, offset=0)
        self.right_wheel = TB6612.Motor(self.Motor_B, offset=0)
