"""
based on SunFounder (service@sunfounder.com) PCA9685.py
"""
...
class PWM(object):
    ...
    def _check_i2c(self):
        ...
        if "%02X" % self.address in addresses:
            print("Wierd, I2C device is connected, Try to run the program again, If problem stills, email this "
                  "information to support@sunfounder.com")
        else:
            print("Device is missing.")
            print("Check the address or wiring of PCA9685 Server driver, or email this information to "
    ...
    def map(self, x, in_min, in_max, out_min, out_max):
        """To map the value from arrange to another"""
