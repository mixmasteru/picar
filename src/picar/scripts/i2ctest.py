...
def main():
    ...
    time.sleep(1)
    print('   Your cpu revision:' + str(CPU_Number))
    time.sleep(1)
    print('   Your Raspberry Pi is Revision' + str(your_pi_revision))
    time.sleep(1)
    print('   Your I2C bus number is:' + str(you_i2c_bus_number))
    time.sleep(1)
    print('')
    time.sleep(1)
